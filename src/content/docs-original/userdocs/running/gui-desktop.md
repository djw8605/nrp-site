**Note that Coder (<https://coder.nrp-nautilus.io>) is currently the preferred method to deploy the GUI Desktop containers. Use the below instructions if you want to deploy in your own namespace.**
