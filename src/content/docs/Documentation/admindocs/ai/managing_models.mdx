...
- **`startupProbe`**: Gives the pod time to load model weights before liveness/readiness checks begin. Large models (30B+) can take 2–10 minutes to initialize. Without this, a liveness probe will kill the pod before it ever finishes loading.
...
|---|---|---|
| < 10B | 1–3 min | 20–30 |
| 10B–40B | 3–10 min | 30–90 |
| 40B–100B | 5–15 min | 60–120 |
| 100B+ / multi-node | 10–30 min | 90–180 |
