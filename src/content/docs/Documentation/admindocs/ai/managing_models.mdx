...
:::caution
When changing the provided models, also change the [Chatbox config template](https://gitlab.nrp-nautilus.io/prp/nrp-site/-/blob/main/src/components/vue/LLMToken.vue?ref_type=heads#L107)
:::
