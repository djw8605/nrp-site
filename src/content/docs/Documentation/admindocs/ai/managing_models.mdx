...
- `PYTORCH_ALLOC_CONF="expandable_segments:True"`, `VLLM_WEIGHT_OFFLOADING_DISABLE_PIN_MEMORY=1` (**both mandatory for all cases of CPU offloading currently**), `VLLM_WEIGHT_OFFLOADING_DISABLE_UVA=1` when `--offload-backend prefetch` is set (refer to https://github.com/vllm-project/vllm/pull/32993)
