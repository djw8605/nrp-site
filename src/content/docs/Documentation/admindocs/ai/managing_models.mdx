...
In this case, `--runner pooling` and `--convert embed` are important arguments for embedding models.
...
Deployment (Legacy and should be ported to a StatefulSet instead):
