...
- `VLLM_WEIGHT_OFFLOADING_DISABLE_PIN_MEMORY=1` (**mandatory for all offloading instances currently**), `VLLM_WEIGHT_OFFLOADING_DISABLE_UVA=1` when `--offload-backend prefetch` is set (refer to https://github.com/vllm-project/vllm/pull/32993)
