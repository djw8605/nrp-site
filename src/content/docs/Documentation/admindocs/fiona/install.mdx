...
<Steps>
    ...
    4. [Verify the node connectivity](#verifying-the-connectivity)

    5. Set node `tenant` (organization that owns the node) to netbox. <b>Look in netbox pod logs on node. Should be happy. If not, will tell you what's missing, update netbox and kick.</b>
