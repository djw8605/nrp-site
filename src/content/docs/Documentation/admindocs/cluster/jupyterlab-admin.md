...
To grant access to the [JupyterLab](https://jupyterhub-west.nrp-nautilus.io) service, first verify the user's email address used for CILogon. It should match the record in the [user portal](https://portal.nrp.ai/users).
