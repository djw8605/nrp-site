...
:::note
[Not all nodes are available to all users](/documentation/userdocs/running/special/). You can consult about your available resources in [Matrix](/documentation/userdocs/start/contact) and on [resources page](https://portal.nrp.ai/resources). 
...
In general the higher CUDA versions support the lower and same driver version. The nodes are labelled with the major and minor CUDA and driver versions. You can check those at the [resources page](https://portal.nrp.ai/resources) or list with this command (it will also choose only GPU nodes):
