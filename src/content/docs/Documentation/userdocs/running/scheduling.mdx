...
To use python client, you can get the OIDC token from the [lookout page](https://armada-lookout.nrp-nautilus.io) in web browser. After logging in, check the site storage developer tab. There will be the id_token stored for authentik.
