...
description: "Authenticate scripts and CI runs against the cluster with service-account tokens instead of the portal kubeconfig."
---
...
> **Note**: In the previous kubernetes versions, the above command also created a token in a secret object.
> (As of 8/16/2023, the server version is v1.25.12.)
> But this is no longer the case, see [here](https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/#manually-create-an-api-token-for-a-serviceaccount).
