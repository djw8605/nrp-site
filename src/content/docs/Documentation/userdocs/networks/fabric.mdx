---
title: Joint Experiments with FABRIC Testbed
description: A tutorial on  cross-testbed experimentation and how to establish a connection between a FABRIC slice and a Kubernetes pod on Nautilus.
---
...
<ul>
  ...
  <li>For more details about the Nautilus nodes, check: <a href="https://nrp.ai/viz/resources" style="color:#1976D2;">Nautilus Resources</a></li>
</ul>
...
<p>
Additionally, we have employed the <span style="color:#0288D1; font-weight:bold;">ESnet SENSE Orchestrator</span> to establish a 1Gbps L2 path between the FABRIC UCSD site and the Nautilus node (<strong>node-2-7.sdsc.optiputer.net</strong>) through a map of VLAN tags listed below. In the time of writing the documentation, these paths were current. For up-to-date paths, please contact the admins via [Nautilus Support](https://nrp.ai/contact) before reproducing.
</p>
...
In the event that the token doesn't work, please contact the NRP admins via [Nautilus Support](https://nrp.ai/contact)
