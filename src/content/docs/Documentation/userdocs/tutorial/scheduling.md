...
# Scheduling
[//]: # (begin GPT-3.5 developed by OpenAI, training data from January 2022, query text "In the context of Kubernetes, what is scheduling?")
...
```
:exclamation:By the way, many of these queries are exposed as part of the Nautilus portal. You can visit the [Resources](https://portal.nrp-nautilus.io/resources) page to see a table with all the current nodes and their features.
