---
title: NRP Accounting MCP Server
description: Query NRP accounting data over MCP or an OpenAPI bridge.
---
...
<CardGrid>
  <LinkCard
    title="Native MCP endpoint"
    href="https://nrp-accounting-mcp.nrp-nautilus.io/"
    description="Preferred when the client supports MCP directly." />
  <LinkCard
    title="OpenAPI bridge"
    href="https://nrp-accounting-mcp.nrp-nautilus.io/openapi"
    description="Use this for Open WebUI and other OpenAPI-only tool clients." />
  <LinkCard
    title="OpenAPI docs"
    href="https://nrp-accounting-mcp.nrp-nautilus.io/openapi/docs"
    description="Interactive docs for the OpenAPI bridge." />
  <LinkCard
    title="Source repository"
    href="https://github.com/djw8605/nrp-clickhouse"
    description="Implementation, manifests, and deployment details." />
</CardGrid>

:::tip
Use the native MCP endpoint when the client supports MCP directly. In practice this has been more reliable than the OpenAPI bridge for structured tool calling.
:::
...
<Card title="OpenAPI authorization">
  `Authorization: Bearer <MCPO_API_KEY>`
</Card>

:::caution
Native MCP has worked better than the OpenAPI bridge in some harnesses because the bridge/client combination can sometimes mis-shape typed parameters such as lists.
:::
...
:::note
Use `gpu`, not `gpu_hours`, when prompting for resources. Canonical resource names are preferred even though common aliases are normalized automatically.
:::
...
<details>
<summary>Deployment and admin notes</summary>

The implementation lives in:

- [`nrp_accounting_pipeline/mcp_server.py`](https://github.com/djw8605/nrp-clickhouse/blob/main/nrp_accounting_pipeline/mcp_server.py)
- [`nrp_accounting_pipeline/accounting_queries.py`](https://github.com/djw8605/nrp-clickhouse/blob/main/nrp_accounting_pipeline/accounting_queries.py)
- [`README.md`](https://github.com/djw8605/nrp-clickhouse/blob/main/README.md)

Kubernetes manifests live under [`k8s/base`](https://github.com/djw8605/nrp-clickhouse/tree/main/k8s/base), including:

- [`deployment-mcp.yaml`](https://github.com/djw8605/nrp-clickhouse/blob/main/k8s/base/deployment-mcp.yaml)
- [`deployment-openapi.yaml`](https://github.com/djw8605/nrp-clickhouse/blob/main/k8s/base/deployment-openapi.yaml)
- [`service-mcp.yaml`](https://github.com/djw8605/nrp-clickhouse/blob/main/k8s/base/service-mcp.yaml)
- [`service-openapi.yaml`](https://github.com/djw8605/nrp-clickhouse/blob/main/k8s/base/service-openapi.yaml)
- [`ingress-mcp.yaml`](https://github.com/djw8605/nrp-clickhouse/blob/main/k8s/base/ingress-mcp.yaml)
- [`configmap.yaml`](https://github.com/djw8605/nrp-clickhouse/blob/main/k8s/base/configmap.yaml)
- [`secret.yaml`](https://github.com/djw8605/nrp-clickhouse/blob/main/k8s/base/secret.yaml)
