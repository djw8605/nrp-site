...
**You don't need to install the operator, create the milvus instance, or create the database. All that is done already for you.**

:::tip
  Milvus GRPC endpoint:
  
  **milvus.grpc.nrp-nautilus.io:50051**
:::
