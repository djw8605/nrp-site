...
<Card title="qwen3" icon="star">
  ...
  <Badge text="evaluating" variant="tip" /><Badge text="batch" variant="success" /><Badge text="tool" variant="success" /><Badge text="multimodal" variant="success" />
...
<Card title="minimax-m2" icon="star">
  ...
  **[MiniMaxAI/MiniMax-M2.5](https://huggingface.co/MiniMaxAI/MiniMax-M2.5)**
  ...
  262,144 context tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/MiniMax/MiniMax-M2.html), Native FP8 model weights, frontier agentic coding performance
</Card>
...
- `qwen3-embedding` ([Qwen/Qwen3-Embedding-8B](https://huggingface.co/Qwen/Qwen3-Embedding-8B)) was added as an available model on the AI Gateway.
