...
:::caution
API users are recommended to set the below configuration if their prompts of responses should only be cached for yourself and not for others. However, this will slightly decrease performance.
:::
