...
<Card title="glm-v" icon="star">
  ...
  **[zai-org/GLM-4.6V-FP8](https://huggingface.co/zai-org/GLM-4.6V-FP8)**
  ...
  Multimodal (vision, video), 131,072 context tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/GLM/GLM-V.html), Official FP8 quantization, Gemini Flash level multimodal performance, use `extra_body={"chat_template_kwargs": {"enable_thinking": False}}` to disable thinking
</Card>
...
- `llama3-sdsc` ([Llama-3.3-70B-Instruct](https://huggingface.co/meta-llama/Llama-3.3-70B-Instruct)) was decommissioned after a long period of deprecation, due to being a model from years ago.
