...
<Card title="glm-4.6" icon="star">

  <Badge text="evaluating" variant="tip" /><Badge text="tool" variant="success" />

  **[QuantTrio/GLM-4.6-GPTQ-Int4-Int8Mix](https://huggingface.co/QuantTrio/GLM-4.6-GPTQ-Int4-Int8Mix)**
  
  202,752 tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/GLM/GLM-4.5.html), GPTQ mixed quantization, frontier agentic coding performance
</Card>
...
<Card title="glm-v" icon="star">
  ...
  **[zai-org/GLM-4.5V-FP8](https://huggingface.co/zai-org/GLM-4.5V-FP8)**
  
  Multimodal (vision, video), 65,536 tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/GLM/GLM-4.5V.html), Official FP8 quantization, GPT-4o level multimodal performance
</Card>
...
<Card title="olmo" icon="star">
  ...
  <Badge text="evaluating" variant="tip" />
