...
| kimi<br/><Badge text="eval" variant="tip" /> | [moonshotai/Kimi-K2-Thinking](https://huggingface.co/moonshotai/Kimi-K2-Thinking) | 262,144 tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/moonshotai/Kimi-K2-Think.html), Native INT4 training, frontier general and agentic coding performance |
