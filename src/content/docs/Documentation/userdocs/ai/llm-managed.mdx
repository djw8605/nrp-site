...
- `kimi` ([moonshotai/Kimi-K2-Thinking](https://huggingface.co/moonshotai/Kimi-K2-Thinking)) is removed due to taking 8 GPUs and having no advantage to `glm-4.7`, as well as tool calling bugs in vLLM.
