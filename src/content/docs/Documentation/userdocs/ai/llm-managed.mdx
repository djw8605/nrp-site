...
| gpt-oss<br/><Badge text="eval" variant="tip" /> | [openai/gpt-oss-120b](https://huggingface.co/openai/gpt-oss-120b) | 131,072 tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/OpenAI/GPT-OSS.html), Native MXFP4 model, frontier agentic performance |
| kimi<br/><Badge text="eval" variant="tip" /> | [moonshotai/Kimi-K2-Thinking](https://huggingface.co/moonshotai/Kimi-K2-Thinking) | 262,144 tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/moonshotai/Kimi-K2-Think.html), Native INT4 model, frontier general and agentic coding performance |
...
| minimax-m2<br/><Badge text="eval" variant="tip" /> | [MiniMaxAI/MiniMax-M2](https://huggingface.co/MiniMaxAI/MiniMax-M2) | 262,144 tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/MiniMax/MiniMax-M2.html), Native FP8 model, frontier agentic coding performance |
