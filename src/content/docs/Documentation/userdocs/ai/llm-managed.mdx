...
<Card title="glm-v" icon="star">
  ...
  <Badge text="main" variant="tip" /><Badge text="batch" variant="success" /><Badge text="tool" variant="success" /><Badge text="multimodal" variant="success" />
...
Added/Changed:`glm-v` was changed to [zai-org/GLM-4.6V-FP8](https://huggingface.co/zai-org/GLM-4.6V-FP8), an upgraded model with larger context size.
