...
<Card title="gemma" icon="star">
  ...
  **[google/gemma-4-31B-it](https://huggingface.co/google/gemma-4-31B-it)**
  ...
  Multimodal (image, video, audio), 262,144 context tokens, 31B parameters, Native bf16 weights, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/Google/Gemma4.html), efficient multimodal and audio capabilities, use `extra_body={"chat_template_kwargs": {"enable_thinking": True}}` to enable thinking
</Card>
...
<Card title="gemma-4-e4b" icon="star">
  ...
  **[google/gemma-4-E4B-it](https://huggingface.co/google/gemma-4-E4B-it)**
  ...
  Multimodal (text, image, **audio**), 65,536 context tokens on the current NRP deployment (model family supports up to 128K), ~4.5B effective parameters, Native bf16 weights, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/Google/Gemma4.html), ASR and speech-to-text translation on the small Gemma 4 line; use `extra_body={"chat_template_kwargs": {"enable_thinking": False}}` to disable thinking when supported by the template

  Hosted in the **`nrp-llm`** pool (API model id **`gemma-4-e4b`**; upstream served name `gemma-4-e4b-it`).
</Card>
...
- `qwen3-small` has been changed from [Qwen/Qwen3.5-27B](https://huggingface.co/Qwen/Qwen3.5-27B) to [Qwen3.5-35B-A3B-FP8](https://huggingface.co/Qwen/Qwen3.5-35B-A3B-FP8), and the context size has been changed.
