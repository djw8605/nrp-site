...
<Card title="qwen3-small" icon="star">
  ...
  **[Qwen3.5-35B-A3B-FP8](https://huggingface.co/Qwen/Qwen3.5-35B-A3B-FP8)**
  ...
  Multimodal (vision, video), 1,010,000 context tokens, 35B parameters, Official FP8 quantization, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/Qwen/Qwen3.5.html), Efficient multimodal and agentic performance, use `extra_body={"chat_template_kwargs": {"enable_thinking": False}}` to disable thinking
</Card>
