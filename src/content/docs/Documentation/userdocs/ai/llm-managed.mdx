...
<Card title="glm-4.7" icon="star">
  ...
  **[zai-org/GLM-4.7-FP8](https://huggingface.co/zai-org/GLM-4.7-FP8)**
  ...
  202,752 tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/GLM/GLM.html), Official FP8 quantization, frontier agentic coding performance, use `"chat_template_kwargs": {"enable_thinking": false}` to disable thinking
</Card>
...
<Card title="glm-v" icon="star">
  ...
  **[zai-org/GLM-4.6V-FP8](https://huggingface.co/zai-org/GLM-4.6V-FP8)**
  ...
  Multimodal (vision, video), 131,072 tokens, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/GLM/GLM-V.html), Official FP8 quantization, Gemini Flash level multimodal performance, use `"chat_template_kwargs": {"enable_thinking": false}` to disable thinking
</Card>
