...
<Card title="qwen3" icon="star">
  ...
  **[Qwen/Qwen3.5-397B-A17B-FP8](https://huggingface.co/Qwen/Qwen3.5-397B-A17B-FP8)**
  ...
  Multimodal (image, video), 1,010,000 context tokens, 397B parameters, Official FP8 quantization, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/Qwen/Qwen3.5.html), Claude/Gemini-level frontier multimodal performance, use `extra_body={"chat_template_kwargs": {"enable_thinking": False}}` to disable thinking
...
<Card title="qwen3-small" icon="star">
  ...
  **[Qwen3.5-35B-A3B-FP8](https://huggingface.co/Qwen/Qwen3.5-35B-A3B-FP8)**
  ...
  Multimodal (image, video), 1,010,000 context tokens, 35B parameters, Official FP8 quantization, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/Qwen/Qwen3.5.html), efficient multimodal and agentic performance, use `extra_body={"chat_template_kwargs": {"enable_thinking": False}}` to disable thinking
</Card>
...
<Card title="gemma-4-e4b" icon="star">
...
<Card title="qwen3-27b" icon="star">

  <Badge text="evaluating" variant="tip" /><Badge text="tool" variant="success" /><Badge text="multimodal" variant="success" /><Badge text="research" variant="success" />

  **[Qwen/Qwen3.5-27B](https://huggingface.co/Qwen/Qwen/Qwen3.5-27B)**
  
  **Not guaranteed to be always online.** Multimodal (image, video), 262,144 context tokens, 27B parameters, bf16 weights, [tool calling](https://docs.vllm.ai/projects/recipes/en/latest/Qwen/Qwen3.5.html), efficient multimodal and agentic performance, use `extra_body={"chat_template_kwargs": {"enable_thinking": False}}` to disable thinking
</Card>
...
- `gemma3` has been renamed to `gemma` and changed from [google/gemma-3-27b-it](https://huggingface.co/google/gemma-3-27b-it) to [google/gemma-4-31B-it](https://huggingface.co/google/gemma-4-31B-it), and the context size has been changed.

- `qwen3-small` has been changed from [Qwen/Qwen3.5-27B](https://huggingface.co/Qwen/Qwen3.5-27B) to [Qwen3.5-35B-A3B-FP8](https://huggingface.co/Qwen/Qwen3.5-35B-A3B-FP8), and the context size has been changed. `qwen3-27b` ([Qwen/Qwen3.5-27B](https://huggingface.co/Qwen/Qwen3.5-27B)) is available as preemptible deployments on idle GPUs.

- `gemma-4-e4b` ([google/gemma-4-E4B-it](https://huggingface.co/google/gemma-4-E4B-it)) was added; API model id **`gemma-4-e4b`**.
