...
3. **Make sure you're on Matrix. All Nautilus and NRP users are expected to join Matrix for user support and real-time updates.**
    :::danger[Joining NRP's Matrix Chat]
    - If you’re not on Matrix yet, please register right away following the instructions at <a href="https://nrp.ai/contact/" target="_blank">**this link.**</a>
    :::
</Steps>
