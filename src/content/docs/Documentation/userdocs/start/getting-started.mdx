...
3. Save the file as **`config`** (without any extension) and put it in your `$HOME/.kube` folder. (Right click the link, "Download linked file").
...
### Cluster access via kubectl (alternative)
