...
9. Access your namespace(s).
    ...
    - If you got added to a namespace as **`user`**, you can verify it by going to the [**Namespaces manager**](https://portal.nrp-nautilus.io/profileN) tab after logging in to the portal. You should be able to “Select your namespace” from a drop-down list.
...
- Containers are stateless. 
    - **All your data will be gone forever when container restarts**, unless you store in a persistent volume.
