...
3. Keep checking the <a href="https://portal.nrp.ai/violations"  target="_blank">**Violations**</a>  page on the Nautilus portal to see if your pods are violating the usage policies.
</Steps>
...
2. If you need to run [some permanent services](/documentation/userdocs/running/ingress/) beyond two weeks, contact admins in [Matrix](/contact) and ask for an exception. 
