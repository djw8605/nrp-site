...
3. Keep checking the <a href="https://nrp.ai/violations"  target="_blank">**Violations**</a>  page on the Nautilus portal to see if your pods are violating the usage policies.
</Steps>
