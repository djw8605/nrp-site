...
- A student (preferably a Ph.D. or Mastars student) can be a namespace admin if their supervisor requests us via email or [Matrix](/contact).
...
:::caution
Single pods without any Workload Controllers will be destroyed after **6 hours**. Look at the [**cluster policies**](policies#interactive-use-6-hours-max-runtime). 
