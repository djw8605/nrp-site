...
The cluster has different types of resources including CPU, GPU,and
 FPGAs.
...
Check the <a href="https://portal.nrp-nautilus.io/resources"  target="_blank">**Resources**</a> page on the portal to see the detailed summary of each node.
...
<center>
<LinkButton href="https://jupyterhub-west.nrp-nautilus.io" target="_blank">Access the NRP-hosted JupyterHub</LinkButton>
</center>
...
<center>
<LinkButton href="https://coder.nrp-nautilus.io/" target="_blank">Access the NRP-hosted Coder</LinkButton>
</center>
...
<center>
<LinkButton href="/documentation/userdocs/start/getting-started" target="_blank">Get started with Kubernetes setup </LinkButton>
</center>
...
You can learn more about these components in the [tutorial sections]((/documentation/userdocs/tutorial/basic/)). 
...
A <a href="https://kubernetes.io/docs/concepts/workloads/controllers/deployment/" target="_blank">Kubernetes deployment</a> manages the lifecycle of application workloads by ensuring the desired number of pod replicas are running and up to date.
