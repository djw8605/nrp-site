---
title: FAQ
description: "Quick answers to common problems on Nautilus, from stuck Terminating pods to storage and access questions."
---
...
> In all these cases, you should ask a cluster admin in [Nautilus Support](/contact) chat to look at your pod, or just wait for somebody to fix it.
