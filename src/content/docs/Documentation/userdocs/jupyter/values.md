---
title: Deploy JupyterHub Helm Chart Values
description: "Example Helm values for a private JupyterHub: CILogon OAuth configuration and notebook image settings."
---
