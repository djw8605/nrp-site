...
You can get your **credentials** (key and secret) in the [user portal](https://nrp.ai), `Storage->S3 Keys` page for public Ceph pools. To get credentials for private ones, contact the admin managing the particular S3 storage.
