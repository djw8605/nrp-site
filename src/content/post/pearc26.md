...
title: "Empowering AI-Enabled Research and Education: NRP Full-Day Tutorial at PEARC26"
excerpt: "NRP presented a full-day hands-on tutorial at PEARC26 showcasing AI workflows, JupyterHub, LLM services, and agentic AI on Kubernetes."
image: ~/assets/images/posts/pearc26.jpg
category: Events
tags:
  - conference
  - tutorial
...
This tutorial introduced participants to using the NRP — an NSF-funded Kubernetes-based system — for interactive AI workflows, classroom instruction, and research applications. Attendees gained practical experience with:
...
## 🌅 Morning Session: Getting Started with NRP
...
- **Introduction to the National Research Platform** — architecture, federated model, and participating sites
...
A highlight of the afternoon was the introduction to **agentic AI workflows** — autonomous AI systems that can plan, execute, and iterate on complex tasks. Demonstrations included:
...
> 📖 **Tutorial Materials:** [nrp-training/pearc26](https://github.com/nrp-nautilus/nrp-training/tree/materials/pearc26)  
> 📅 **PEARC26 Session Page:** [ACM PEARC 2026 Schedule](https://pearc.acm.org/pearc26/conference-schedule/#session=6af5f905-8951-4cd4-a513-b9b1e0974d11)

---

## Looking Forward

The success of the PEARC26 tutorial underscores the growing demand for **accessible, national-scale AI infrastructure** that supports both education and research. As the NRP continues to expand its capabilities — from traditional GPU workloads to emerging technologies like Qualcomm Cloud AI accelerators and agentic AI frameworks — we invite the broader community to join us in building the future of cyberinfrastructure-enabled science.

Stay tuned for updates on upcoming workshops, new service deployments, and opportunities to collaborate with the NRP team.

---

![NRP at PEARC26 Tutorial](~/assets/images/posts/pearc26.jpg)
