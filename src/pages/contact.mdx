...
4. Click explore rooms button. Check that you're exploring the NRP server (matrix.nrp-nautilus.io). You'll automatically join the Nautilus General channel and the News channel. For all other homeservers including Matrix.org, you can directly access and join the [NRP Matrix Space](https://matrix.to/#/%23nrp:matrix.nrp-nautilus.io) for all channels.
