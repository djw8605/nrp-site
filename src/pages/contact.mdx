...
To let us find you by email (in case we need to link your NRP account to your matrix account) please enable the identity server integration. Go to Settings in Element (Your Account -> All Settings -> Security & Privacy) and mark accept under the Privacy header:
