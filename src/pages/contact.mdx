...
<div class="not-prose my-8 p-6 sm:p-8 rounded-2xl border border-gray-200 dark:border-gray-700 bg-gradient-to-br from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 shadow-sm flex flex-col sm:flex-row sm:items-center gap-5">
  <div class="flex-shrink-0 flex items-center justify-center w-14 h-14 rounded-full bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300"><Icon name="tabler:mail" class="w-7 h-7" /></div>
  <div class="flex-1">
    <h2 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white mb-1">Email Support</h2>
    <div class="text-sm text-gray-600 dark:text-gray-300 mb-3">For questions about accounts, namespaces, hosted LLM access, or anything else, drop us a line.</div>
    <a class="btn-primary inline-flex items-center gap-2 max-w-full whitespace-normal break-all text-sm" href="mailto:support@nationalresearchplatform.org"><Icon name="tabler:mail" class="w-4 h-4 inline-block flex-shrink-0" /><span>{"support@nationalresearchplatform.org"}</span></a>
  </div>
</div>

## Main Communication Channel — Matrix

All **Nautilus and NRP users are expected to join Matrix** for user support and real-time updates. We're using the new innovative federated communication system [https://matrix.org](https://matrix.org). You can get an account using any compatible client.
...
**If you’re not on Matrix yet, please register right away following the instructions below.**
